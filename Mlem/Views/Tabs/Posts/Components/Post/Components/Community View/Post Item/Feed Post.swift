...
struct FeedPost: View
{
                            ...
                            .onEnded {
                                ...
                                if w < -1 * AppConstants.longSwipeDragMin {
                                    if let account = account {
                                        ...
                                        displayToast(AlertToast(displayMode: .banner(.pop), type: .regular, title: "Only registered accounts can reply to posts"))
                                    }
                                }
                                else if w < -1 * AppConstants.shortSwipeDragMin {
    ...
    guard let account = account else { return displayToast(AlertToast(displayMode: .banner(.pop), type: .regular, title: "Only registered accounts can save posts")) }
        do {
